...
public class ProductInformation {
    ...
    @Test
    public void ProductInformation() throws MalformedURLException {
...
/*
WebElement serialNumberText = driver.findElementById("lblMotorSN");
        System.out.println(serialNumberText.getText());
